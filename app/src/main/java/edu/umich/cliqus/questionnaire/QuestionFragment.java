...
public class QuestionFragment extends Fragment {
    ...
    private LinearLayout checkboxes_list;
    ...
    public static QuestionFragment newInstance(Questionnaire que) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            QuestionFragment = (QuestionFragment) getArguments().getSerializable(SELECTEDQUESTION);
        }
    }
